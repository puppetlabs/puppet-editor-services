...
describe 'Puppet::Parser::Compiler' do
  ...
  before(:each) do
    allow(PuppetDebugServer::PuppetDebugSession.instance).to receive(:execute_hook).with(any_args)
  ...
  context 'Given a invocation that will raise an error' do
    ...
    it 'should raise an exception breakpoint' do
      expect(PuppetDebugServer::PuppetDebugSession.instance).to receive(:execute_hook).with(:hook_exception, any_args)
